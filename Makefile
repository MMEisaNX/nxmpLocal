...
DATA		:=	data
INCLUDES	:=	source/dvdnav source/pdfloader libs/nxmp-devoptabs/devoptabsfs/nfsfs/ libs/nxmp-devoptabs/devoptabsfs/smb2fs libs/nxmp-devoptabs/devoptabsfs/sshfs libs/nxmp-devoptabs/devoptabsfs/m3u8fs libs/nxmp-devoptabs/devoptabsfs/ftpfs libs/nxmp-devoptabs/devoptabsfs/libarchivefs source/backends/native-deko3d source/i18n source/backends source/iniparser source/imgloader source/networkshareclass source/UI source/UI/textscroller source/mediaprobe libs/imgui_toggle source/fileBrowser source/logger source/stats libs/simpleini libs/imgui include source/curldownloader source/updater source/touchcontrols source/playlist source/shadermania source/eqpreset source/database source/remotefs/UPNP source/remotefs/nfsDir source/remotefs/smb2 source/remotefs/sshDir source/remotefs/Enigma2 source/localfs source/localfs/usb source/remotefs/ftplib source/remotefs/HTTPDir source/libmpv
ROMFS		:=	romfs
